...
public class MainFrame {
	...
	private void initialize() {
		...
		//Button to implement git branch function
		...
		//Button to implement git fetch function
		...
		//Button to implement git pull function
		...
		//Button to implement git merge function
		...
		//Button to show the changes pushed in recent commit
		...
		//Button to implement git log function
